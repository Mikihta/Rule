...
echo "=========================================="
echo " Installing Home Assistant 2024.11.1 ..."
echo "=========================================="

(
wget -q https://raw.githubusercontent.com/home-assistant/core/2024.11.1/homeassistant/package_constraints.txt -O -
wget -q https://raw.githubusercontent.com/home-assistant/core/2024.11.1/requirements.txt -O -
wget -q https://raw.githubusercontent.com/home-assistant/core/2024.11.1/requirements_all.txt -O -
...
cd /tmp
rm -rf homeassistant.tar.gz homeassistant-2024.11.1 .cache pip-*
wget https://pypi.python.org/packages/source/h/homeassistant/homeassistant-2024.11.1.tar.gz -O homeassistant.tar.gz
...
cd homeassistant-2024.11.1/homeassistant/
...
cd ../
rm -rf homeassistant-2024.11.1/ ${HA_BUILD} ${STORAGE_TMP}
